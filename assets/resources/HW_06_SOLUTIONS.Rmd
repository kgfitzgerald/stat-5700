...
<!-- For $n=8$: -->
<!-- $$P(\text{none defective}) = \frac{% raw %}{{17 \choose 8}}{% endraw %}}{% raw %}{{20 \choose 8}}{% endraw %}} = 0.193$$ -->

<!-- ## 3.120 -->
<!-- There are $N$ animals. After marking $k$, we draw a second sample of 3. -->

<!-- Number of ways to find exactly one marked animal: -->
<!-- $$P(Y=1) = \frac{% raw %}{{k \choose 1}}{% endraw %} {% raw %}{{N-k \choose 2}}{% endraw %}}{% raw %}{{N \choose 3}}{% endraw %}}$$ -->

<!-- For $k=4$: -->
<!-- $$P(Y=1) = \frac{% raw %}{{4 \choose 1}}{% endraw %} {% raw %}{{N-4 \choose 2}}{% endraw %}}{% raw %}{{N \choose 3}}{% endraw %}}$$ -->

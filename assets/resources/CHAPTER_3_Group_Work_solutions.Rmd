...
For X, count the number of times the result is 0, and divide by 10,000. This proportion will be a good estimate of P(X = 0) = p(0). The same is done for X = 1,2,3. This will define the probability distribution. Plotting the 10,000 values of X would give you a visual of the distribution. 
...
# Back of Packet Group Work Solutions

## Problem 1

For each of the following, determine the constant $c$ so that $f(x)$ satisfies the conditions of being a pmf for a random variable $X$. That is, find $c$ such that $\sum_{x \in S} f(x) = 1$.

...
\def\labelenumi{(\alph{enumi})}
\item
  Geometric probability: \[(0.8)^2 (0.2) = 0.128\]
\item
  Negative binomial probability: \[\binom{6}{2} (0.2^3)(0.8^4) = 0.049\]
\item
...
Then \[p(2) = \frac{1^2 e^{-1}}{2!} = 0.1839\]

\section{Submitted Problems}\label{submitted-problems}

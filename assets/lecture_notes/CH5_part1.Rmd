...
::: {.activitybox data-latex=""}
**Example** Gasoline is stocked in a bulk tank once at the beginning of each week and then sold to invidual customers. Let $X$ denote the proportion of the capacity of the bulk tank that is available after the tank is stocked at the beginning of the week. Becaues of the limited supplies, $X$ varies from week to week. Let $Y$ denote the proportion of the capacity of the bulk tank that is sold during the week. Both are proportions, so are restricted between 0 and 1, and further, the amount sold $y$ cannot exceed the amount available $x$. Suppose that the joint density function for $X$ and $Y$ is given by:

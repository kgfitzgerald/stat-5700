...
-   Hypergeometric (\# of successes when sampling w/o replacement
    from finite pop): {0, 1, 2, ... r}
-   Poisson (\# of occurrences in unit interval) $\{1, 2, \dots\}$
...
SAT scores are distributed nearly normally with mean 1000 and standard
deviation 200.
...
$$\Phi(z) = F(z) = P(Z \leq z) = \int_{-\infty}^z\frac{1}{\sqrt{2\pi}}e^{-w^2/2}dw$$
:::

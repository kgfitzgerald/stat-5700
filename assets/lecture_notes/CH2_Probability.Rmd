...
**Example (cont'd)**: Using the same scenario as above (three coin tosses), define the following additional events: 
...
**Exercise**: What if there are 10 people and 3 identical prizes - how many
...
# 2.8 A few theorems & laws of probability
...
::: {.highlightbox data-latex=""}
**Theorem 2.6: The Additive Law of Probability** The probability of the union of two events A and B is
...
**Theorem 2.7**: If A is an event, then $P(A) = 1 - P(A')$

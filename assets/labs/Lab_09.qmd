...
Use the three objects from Task 1 to compute the correlation of `mpg` and `wt`, using formulas from Chapter 5.
...
Compute the slope of the least squares regression line for this data using the formulas derived in Chapter 5.
...
Based on your results from Additional Problem #3 on the homework, do you expect this change in units to change the correlation between mpg and weight?

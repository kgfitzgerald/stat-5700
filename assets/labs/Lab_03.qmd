...
In this lab, you will actually conduct the simulations that you wrote psuedocode for in the in-class simulation activity in the Ch 3 lecture notes packet.
...
How do these compare to the true expected values you computed during the in-class group work?
